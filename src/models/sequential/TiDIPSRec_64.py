...
class TiDIPSRec_64Base(object):
    ...
    def parse_model_args(parser):
        ...
        parser.add_argument('--time_max', type=int, default=64,
...
class TiDIPSRec_64(SequentialModel, TiDIPSRec_64Base):
    reader = 'SeqReader'
    runner = 'BaseRunner'
    ...
    @staticmethod
    def parse_model_args(parser):
        parser = TiDIPSRec_64Base.parse_model_args(parser)
    ...
    def forward(self, feed_dict):
        out_dict = TiDIPSRec_64Base.forward(self, feed_dict)
        # return {'prediction': out_dict['prediction']}
        return {'prediction': out_dict['prediction'], 'kl': out_dict['kl']}
    
class TiDIPSRec_64Impression(ImpressionSeqModel, TiDIPSRec_64Base):
    ...
    def forward(self, feed_dict):
        return TiDIPSRec_64Base.forward(self, feed_dict)
...
class MISRec_top1000Base(object):
    @staticmethod
...
class MISRec_top1000(SequentialModel, MISRec_top1000Base):
    reader = 'SeqReader'
    runner = 'BaseRunner'
    ...
    @staticmethod
    def parse_model_args(parser):
        parser = MISRec_top1000Base.parse_model_args(parser)
    ...
    def forward(self, feed_dict):
        out_dict = MISRec_top1000Base.forward(self, feed_dict)
        # return {'prediction': out_dict['prediction']}
        return {'prediction': out_dict['prediction'], 'kl': out_dict['kl']}
    
class MISRec_top1000Impression(ImpressionSeqModel, MISRec_top1000Base):
    ...
    def forward(self, feed_dict):
        return MISRec_top1000Base.forward(self, feed_dict)
...
class RtMIPSRec_3i(SequentialModel, RtMIPSRec_3iBase):
    reader = 'SeqReader'
    runner = 'BaseRunner'
    ...
    @staticmethod
    def parse_model_args(parser):
        parser = RtMIPSRec_3iBase.parse_model_args(parser)
    ...
    def forward(self, feed_dict):
        out_dict = RtMIPSRec_3iBase.forward(self, feed_dict)
        # return {'prediction': out_dict['prediction']}
        return {'prediction': out_dict['prediction'], 'kl': out_dict['kl']}
    
class RtMIPSRec_3iImpression(ImpressionSeqModel, RtMIPSRec_3iBase):
    ...
    def forward(self, feed_dict):
        return RtMIPSRec_3iBase.forward(self, feed_dict)
...
class MISRec_hw06(SequentialModel, MISRec_hw06Base):
    reader = 'SeqReader'
    runner = 'BaseRunner'
    ...
    @staticmethod
    def parse_model_args(parser):
        parser = MISRec_hw06Base.parse_model_args(parser)
    ...
    def forward(self, feed_dict):
        out_dict = MISRec_hw06Base.forward(self, feed_dict)
        # return {'prediction': out_dict['prediction']}
        return {'prediction': out_dict['prediction'], 'kl': out_dict['kl']}
    
class MISRec_hw06Impression(ImpressionSeqModel, MISRec_hw06Base):
    ...
    def forward(self, feed_dict):
        return MISRec_hw06Base.forward(self, feed_dict)
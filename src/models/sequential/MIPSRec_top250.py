...
class MISRec_top250Base(object):
    @staticmethod
...
class MISRec_top250(SequentialModel, MISRec_top250Base):
    reader = 'SeqReader'
    runner = 'BaseRunner'
    ...
    @staticmethod
    def parse_model_args(parser):
        parser = MISRec_top250Base.parse_model_args(parser)
    ...
    def forward(self, feed_dict):
        out_dict = MISRec_top250Base.forward(self, feed_dict)
        # return {'prediction': out_dict['prediction']}
        return {'prediction': out_dict['prediction'], 'kl': out_dict['kl']}
    
class MISRec_top250Impression(ImpressionSeqModel, MISRec_top250Base):
    ...
    def forward(self, feed_dict):
        return MISRec_top250Base.forward(self, feed_dict)
...
class MIPSRec_4mi(SequentialModel, MIPSRec_4miBase):
    reader = 'SeqReader'
    runner = 'BaseRunner'
    ...
    @staticmethod
    def parse_model_args(parser):
        parser = MIPSRec_4miBase.parse_model_args(parser)
    ...
    def forward(self, feed_dict):
        out_dict = MIPSRec_4miBase.forward(self, feed_dict)
        # return {'prediction': out_dict['prediction']}
        return {'prediction': out_dict['prediction'], 'kl': out_dict['kl']}
    
class MIPSRec_4miImpression(ImpressionSeqModel, MIPSRec_4miBase):
    ...
    def forward(self, feed_dict):
        return MIPSRec_4miBase.forward(self, feed_dict)
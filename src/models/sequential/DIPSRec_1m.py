...
class DIPSRec_1m(SequentialModel, DIPSRec_1mBase):
    reader = 'SeqReader'
    runner = 'BaseRunner'
    ...
    @staticmethod
    def parse_model_args(parser):
        parser = DIPSRec_1mBase.parse_model_args(parser)
    ...
    def forward(self, feed_dict):
        out_dict = DIPSRec_1mBase.forward(self, feed_dict)
        # return {'prediction': out_dict['prediction']}
        return {'prediction': out_dict['prediction'], 'kl': out_dict['kl']}
    
class DIPSRec_1mImpression(ImpressionSeqModel, DIPSRec_1mBase):
    ...
    def forward(self, feed_dict):
        return DIPSRec_1mBase.forward(self, feed_dict)
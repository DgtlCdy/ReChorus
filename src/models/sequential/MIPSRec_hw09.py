...
class MISRec_hw09(SequentialModel, MISRec_hw09Base):
    reader = 'SeqReader'
    runner = 'BaseRunner'
    ...
    @staticmethod
    def parse_model_args(parser):
        parser = MISRec_hw09Base.parse_model_args(parser)
    ...
    def forward(self, feed_dict):
        out_dict = MISRec_hw09Base.forward(self, feed_dict)
        # return {'prediction': out_dict['prediction']}
        return {'prediction': out_dict['prediction'], 'kl': out_dict['kl']}
    
class MISRec_hw09Impression(ImpressionSeqModel, MISRec_hw09Base):
    ...
    def forward(self, feed_dict):
        return MISRec_hw09Base.forward(self, feed_dict)
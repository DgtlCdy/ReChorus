...
class MIPSRec_hw09(SequentialModel, MIPSRec_hw09Base):
    reader = 'SeqReader'
    runner = 'BaseRunner'
    ...
    @staticmethod
    def parse_model_args(parser):
        parser = MIPSRec_hw09Base.parse_model_args(parser)
    ...
    def get_gram_matrix(self, dataset):
        ...
        gram_matrix = gram_matrix * 0.9 + gram_matrix_r2 * 0.1
    ...
    def forward(self, feed_dict):
        out_dict = MIPSRec_hw09Base.forward(self, feed_dict)
        # return {'prediction': out_dict['prediction']}
        return {'prediction': out_dict['prediction'], 'kl': out_dict['kl']}
    
class MIPSRec_hw09Impression(ImpressionSeqModel, MIPSRec_hw09Base):
    ...
    def forward(self, feed_dict):
        return MIPSRec_hw09Base.forward(self, feed_dict)
...
class MIPSRec_top1000Base(object):
    @staticmethod
...
class MIPSRec_top1000(SequentialModel, MIPSRec_top1000Base):
    reader = 'SeqReader'
    runner = 'BaseRunner'
    ...
    @staticmethod
    def parse_model_args(parser):
        parser = MIPSRec_top1000Base.parse_model_args(parser)
    ...
    def forward(self, feed_dict):
        out_dict = MIPSRec_top1000Base.forward(self, feed_dict)
        # return {'prediction': out_dict['prediction']}
        return {'prediction': out_dict['prediction'], 'kl': out_dict['kl']}
    
class MIPSRec_top1000Impression(ImpressionSeqModel, MIPSRec_top1000Base):
    ...
    def forward(self, feed_dict):
        return MIPSRec_top1000Base.forward(self, feed_dict)
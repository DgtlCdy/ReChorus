...
class TiDIPSRec_3i(SequentialModel, TiDIPSRec_3iBase):
    reader = 'SeqReader'
    runner = 'BaseRunner'
    ...
    @staticmethod
    def parse_model_args(parser):
        parser = TiDIPSRec_3iBase.parse_model_args(parser)
    ...
    def forward(self, feed_dict):
        out_dict = TiDIPSRec_3iBase.forward(self, feed_dict)
        # return {'prediction': out_dict['prediction']}
        return {'prediction': out_dict['prediction'], 'kl': out_dict['kl']}
    
class TiDIPSRec_3iImpression(ImpressionSeqModel, TiDIPSRec_3iBase):
    ...
    def forward(self, feed_dict):
        return TiDIPSRec_3iBase.forward(self, feed_dict)
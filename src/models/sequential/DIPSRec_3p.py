...
class DIPSRec_3p(SequentialModel, DIPSRec_3pBase):
    reader = 'SeqReader'
    runner = 'BaseRunner'
    ...
    @staticmethod
    def parse_model_args(parser):
        parser = DIPSRec_3pBase.parse_model_args(parser)
    ...
    def forward(self, feed_dict):
        out_dict = DIPSRec_3pBase.forward(self, feed_dict)
        # return {'prediction': out_dict['prediction']}
        return {'prediction': out_dict['prediction'], 'kl': out_dict['kl']}
    
class DIPSRec_3pImpression(ImpressionSeqModel, DIPSRec_3pBase):
    ...
    def forward(self, feed_dict):
        return DIPSRec_3pBase.forward(self, feed_dict)
...
class ContextReader(BaseReader):
    ...
    def parse_data_args(parser):
        parser.add_argument('--include_item_features',type=int, default=0, help='Whether include item context features (0 or 1).')
        parser.add_argument('--include_user_features',type=int, default=0, help='Whether include user context features (0 or 1).')
        parser.add_argument('--include_situation_features',type=int, default=0, help='Whether include situation (i.e., dynamic context) features (0 or 1).')

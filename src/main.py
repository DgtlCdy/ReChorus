...
if __name__ == '__main__':
    ...
    # init_parser.add_argument('--model_name', type=str, default='MIPSRec_TIP', help='Choose a model to run.')
    # init_parser.add_argument('--model_name', type=str, default='MIPSRec_VAE', help='Choose a model to run.')
    # init_parser.add_argument('--model_name', type=str, default='MIPSRec_Test', help='Choose a model to run.')
    ...
    init_parser.add_argument('--model_name', type=str, default='RtMIPSRec', help='Choose a model to run.')
